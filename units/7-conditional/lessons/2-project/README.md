...
See [here](solution_code/) for code and [here](https://rawgit.com/ScriptEdcurriculum/curriculum/master/units/6-conditional/lessons/2-project/solution_code/index.html) to view.
